<%@ Control Language="C#" AutoEventWireup="true" Inherits="PetShop.Web.ProductsControl" EnableViewState="false" Codebehind="ProductsControl.ascx.cs" %>
<%@ Register TagPrefix="PetShopControl" Namespace="PetShop.Web" Assembly="PetShopWebRole" %>
